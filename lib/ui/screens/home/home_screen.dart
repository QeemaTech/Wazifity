...
import 'package:wazifati/data/helper/designs.dart';
import 'package:wazifati/data/model/home/home_screen_section.dart';
import 'package:wazifati/data/model/item/item_model.dart';
import 'package:wazifati/data/model/system_settings_model.dart';
import 'package:wazifati/ui/screens/ad_banner_screen.dart';
import 'package:wazifati/ui/screens/home/slider_widget.dart';
import 'package:wazifati/ui/screens/home/widgets/category_widget_home.dart';
import 'package:wazifati/ui/screens/home/widgets/grid_list_adapter.dart';
import 'package:wazifati/ui/screens/home/widgets/home_search.dart';
import 'package:wazifati/ui/screens/home/widgets/home_sections_adapter.dart';
import 'package:wazifati/ui/screens/home/widgets/location_widget.dart';
import 'package:wazifati/ui/screens/native_ads_screen.dart';
...
import 'package:wazifati/utils/notification/awsome_notification.dart';
import 'package:wazifati/utils/notification/notification_service.dart';
              ...
              children: [
                ...
                GridListAdapter(
                    ...
                    builder: (context, int index, bool isGrid) {
                      int startIndex = index * crossAxisCount;
                      return SizedBox(
                        ...
                        child: Row(
                          ...
                          children: List.generate(crossAxisCount, (i) {
                            ...
                            if (currentIndex >= items) return SizedBox.shrink();
                            return Expanded(
                              child: Padding(
                                padding: EdgeInsets.only(
                                    right: i == crossAxisCount - 1 ? 0 : 15),
                                child:
                                    ItemCard(item: state.items[currentIndex]),
                              ),
                            );
                          }),
                        ),
