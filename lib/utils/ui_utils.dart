...
import 'package:wazifati/ui/screens/widgets/full_screen_image_view.dart';
import 'package:wazifati/ui/screens/widgets/gallery_view.dart';
...
import 'package:wazifati/utils/network_to_localsvg.dart';
...
class UiUtils {
  ...
  static Widget getPriceWidget(ItemModel item, BuildContext context) {
    ...
    if (category.isJobCategory == 1) {
      final min = _toDouble(item.minSalary);
      final max = _toDouble(item.maxSalary);
      ...
      final price = _toDouble(item.price) ?? 0.0;
      return CustomText(
        price.currencyFormat,
        color: color,
        fontWeight: FontWeight.bold,
